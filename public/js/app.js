      ...
      .when('/questions/:id', {
        ...
        templateUrl: 'modules/questions/views/questions.html'
			...
			.when('/mentors', {
				...
				templateUrl: 'modules/mentors/views/mentors.html'
			})
			.when('/newMentor', {
				controller: 'newMentorCtrl',
				templateUrl: 'modules/mentors/views/newMentor.html'
			})
			.when('/updateMentor/:id', {
				controller: 'mentorCtrl',
				templateUrl: 'modules/mentors/views/updateMentor.html'
			})
